...
class ContentPage {
  constructor(page) {
    ...
    // Verwachte teksten voor validatie
    this.expectedTexts = [
  ...
  // Methode om zichtbaarheid van de home, products en contact elementen te valideren
  ...
  // Methode om de teksten onder de #content-locator te valideren
